...
JOIN STARSIN SI ON MS.NAME = SI.STARNAME JOIN MOVIE M ON SI.MOVIETITLE = M.TITLE AND SI.MOVIEYEAR = M.YEAR JOIN MOVIEEXEC ME ON M.PRODUCERC# = ME.CERT#
WHERE MS.GENDER = 'F' AND ME.NETWORTH > 10000000;

SELECT DISTINCT MS.NAME FROM MOVIESTAR MS WHERE NAME NOT IN (SELECT NAME FROM STARSIN SI
JOIN MOVIE M ON SI.MOVIETITLE = M.TITLE AND SI.MOVIEYEAR = M.YEAR JOIN MOVIEEXEC ME ON M.PRODUCERC# = ME.CERT#
